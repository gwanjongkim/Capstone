            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    _DetailImage(asset: asset, fallbackLabel: item.imageFileName),
                    ...
                    if ((item.acutComparisonReason ?? '').trim().isNotEmpty) ...[
                      const SizedBox(height: 12),
                      _ReasonCard(
                        title: '비교 이유',
                    ...
                    if (generatedAt != null || (rankingStage ?? '').trim().isNotEmpty) ...[
                      const SizedBox(height: 18),
                      Text(
                        _buildFooterText(),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _MetricRow(label: 'vila_score_raw', value: _formatDouble(item.vilaScoreRaw)),
          _MetricRow(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(body, style: AppTextStyles.body14),
        ],
      ),
    );
  }
